...
> 1. "복불복에서 게임 시작"
> 2. "복불복에서 5인용 복불복 게임 시작"
> 3. "복불복에서 선택 게임 시작"

### 대표 시나리오

> 사용자 1 : "복불복에서 게임 시작"<br>
...
#### STEP 1. 실행
> 대표발화 "복불복에서 게임 시작" 을 외치면 빅스비가 "몇분이 게임을 진행하시나요?" 라고 묻게됩니다.<br>
...
> 단, "복불복에서 5인용 복불복 게임 시작" 처럼 외치면 5명이 NumPlayer에 적용되어 바로 게임이 시작됩니다.<br>
...
#### STEP 2. 최초 사용자 선택 진행
> STEP 1에서 n명 이라고 발화를 하거나, "복불복에서 n인용 복불복 게임 시작" 을 발화하면, STEP 2로 진입합니다.<br>
